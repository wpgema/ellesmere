                                ...
                                <form action="" method="post">
                                    ...
                                    <tr>
                                        <?php if(empty($carts1[0]["telp"])) : ?>
                                            <td colspan="5"><input type="text" class="form-control" placeholder="Telp" name="telp"/></td>
                                        <?php else : ?>
                                            <td colspan="5"><input type="hidden" class="form-control" placeholder="Telp" name="telp" value="<?= $carts1[0]["telp"] ?>"/></td>
                                        <?php endif; ?>
                                    </tr>
                                    <tr>
                                        <td colspan="5">
                                            <select name="id_employe" id="" class="form-control">
                                    ...
                                    <tr>
                                        <td colspan="5">
                                            <input type="text" class="form-control" placeholder="Catatan Mekanik" name="note"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <?php if($carts[0]['kode_product'] != "jasa_servis") : ?>
                                            <td colspan="4"><input type="number" class="form-control" placeholder="Biaya Layanan" name="total_service"/></td>
                                        <?php else : ?>
                                            <td colspan="4"><input type="hidden" class="form-control" placeholder="Biaya Layanan" name="total_service"/></td>
                                        <?php endif; ?>
