...
<!--begin::App Content Header-->
            ...
            <div class="row justify-content-center mb-3 p-3 bg-white">
                <div class="col-lg-12">
                    ...
                    <table class="table mt-3">
                        ...
                        <tbody>
                            <?php $i = 1; foreach($pengeluaran as $pnjl) : ?>
                                <tr class="align-middle">
                                    <td style="width: 10px"><?= $i; ?></td>
                                    <td><?= $pnjl["bulan"] ?></td>
                                    <td>Rp. <?= number_format($pnjl["amount"]) ?></td>
                                    <td>
                                        <a href="<?= base_url()  ?>laporan-pengeluaran/<?= $pnjl["bulan_angka"] ?>" class="border-0 my-1 btn btn-sm btn-primary">Detail</a>
                                    </td>
                                </tr>
                            <?php $i++; endforeach; ?>
                        </tbody>
    ...
    <!-- Removed duplicate local Chart includes to avoid conflicts with CDN Chart.js -->
<!--end::App Content-->
<?php $this->endSection() ?>